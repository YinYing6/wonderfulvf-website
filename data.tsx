...
export const getProducts = (lang: Language): Product[] => {
  ...
  
  {
    ...
    image: '/assets/images/sweet-corn-bulk.png'
  },
  {
    id: 'c2',
    ...
    packaging: t('Sold in quantity of gunny sack', 'Dijual dalam kuantiti guni', '以麻袋数量出售'),
    image: '/assets/images/pearl-corn-bulk.png'
  },
  {
    id: 'c3',
    ...
    image: '/assets/images/ready-cut-corn.png'
  },
  {
    id: 'c4',
    ...
    image: '/assets/images/sweet-corn-3pcs.png'
  },
  {
    id: 'c5',
    ...
    packaging: t('3 pcs pack', 'Pek 3 keping', '3个装'),
    image: '/assets/images/pearl-corn-3pcs.png'
  },
  {
    id: 'c6',
    ...
    image: '/assets/images/sweet-corn-2kg.png'
  },
  {
    id: 'c7',
    ...
    image: '/assets/images/sweet-corn-2pcs.png'
  },
  {
    id: 'c8',
    ...
    description: t('Fresh Pearl Corn pre-packed.', 'Jagung Mutiara Segar siap dibungkus.', '新鲜珍珠玉米预包装。'),
    packaging: t('2 pcs pack', 'Pek 2 keping', '2个装'),
    image: '/assets/images/pearl-corn-2pcs.png'
  },
  {
    id: 'c9',
    ...
    image: '/assets/images/sweet-corn-500g.png'
  },
  ...
  },
  {
    ...
    image: '/assets/images/ubikayu.png'
  },
  {
    id: 'f1',
    ...
    image: '/assets/images/yambean.png'
  },
  {
    id: 'rt4',
    ...
    image: '/assets/images/local-yam.png'
  },
...

  {
    ...
    image: '/assets/images/amra.png'
  },
  {
    id: 'fr2',
    name: t('Jackfruit', 'Nangka', '菠萝蜜'),
    category: cat('FRUITS') as any,
    description: t('Sweet, aromatic, and fleshy tropical fruit.', 'Buah tropika yang manis, beraroma, dan berisi tebal.', '甜美、芳香、肉质丰厚的带水果。'),
  ...
  {
    id: 'v3',
    name: t('Winter Melon (Labu Kundur)', 'Labu Kundur', '冬瓜'),
    category: cat('VEGETABLES') as any,
    description: t('Ideal for soups, herbal drinks, and fillings.', 'Ideal untuk sup, minuman herba, dan inti.', '非常适合制作汤、凉茶和馅料。'),
...
export const getTimeline = (lang: Language): TimelineEvent[] => {
  ...
  return [
    ...
    },
    {
      ...
      description: t(
        'Increased supplier network by 3X and introduced refrigerated transport.',
        'Meningkatkan rangkaian pembekal sebanyak 3X dan memperkenalkan pengangkutan sejuk beku.',
        '供应商网络增加了3倍，并引入了冷藏运输。'
      )
    },
    {
      ...
      description: t(
        'Incorporated as Wonderful V&F Sdn. Bhd. Achieved ISO 22000 certification (2020), 7-state distribution coverage, and 50+ contracted farms.',
        'Diperbadankan sebagai Wonderful V&F Sdn. Bhd. Mencapai pensijilan ISO 22000 (2020), liputan pengedaran 7 negeri, dan 50+ ladang kontrak.',
        '注册为 Wonderful V&F Sdn. Bhd.。获得 ISO 22000 认证 (2020)，覆盖7个州的配送，并拥有50多个签约农场。'
      )
    }
  ];
};